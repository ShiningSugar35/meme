...
- 最终后端全量回归 **206/206 pass**；scheduler recovery targeted 12/12；frontend `tsc -b && vite build` pass。主 Phase16 实现已提交并 push：`26db419 feat: productionize phase16 sparse risk policy`。
