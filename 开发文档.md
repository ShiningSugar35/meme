...
- 新增真实 adapter smoke 与回归：CatBoost/FLAML 均完成 `build_pipeline → fit_pipeline → predict_proba`；FLAML unit smoke 验证 `time/holdout`、概率输出与非等权拒绝。当前全量后端测试为 142/142，前端 production build 通过。
