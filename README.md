...
# Entry sizing, USD based
ENTRY_SIZE_LIQUIDITY_PCT=0.015
ENTRY_MAX_USD=200

# Risk Feature Scan Tiers - USD based
RISK_FEATURE_SCAN_TIER_1_USD=150
RISK_FEATURE_SCAN_TIER_1_SECONDS=2

RISK_FEATURE_SCAN_TIER_2_USD=100
RISK_FEATURE_SCAN_TIER_2_SECONDS=3

RISK_FEATURE_SCAN_TIER_3_USD=50
RISK_FEATURE_SCAN_TIER_3_SECONDS=6

RISK_FEATURE_SCAN_TIER_4_USD=25
RISK_FEATURE_SCAN_TIER_4_SECONDS=12

RISK_FEATURE_SCAN_TIER_5_SECONDS=24

# Top1 addr_type=0 holder scan tiers - USD based
TOP1_HOLDER_SCAN_TIER_1_USD=150
TOP1_HOLDER_SCAN_TIER_1_SECONDS=10

TOP1_HOLDER_SCAN_TIER_2_USD=100
TOP1_HOLDER_SCAN_TIER_2_SECONDS=15

TOP1_HOLDER_SCAN_TIER_3_USD=50
TOP1_HOLDER_SCAN_TIER_3_SECONDS=30

TOP1_HOLDER_SCAN_TIER_4_USD=25
TOP1_HOLDER_SCAN_TIER_4_SECONDS=60

# 0 = below $25 does not run dedicated Top1 scan
TOP1_HOLDER_SCAN_TIER_5_SECONDS=0

# Dust Position Rules - USD based
DUST_FORCE_EXIT_USD=12.5

# Legacy fallback only; keep it to avoid old call sites breaking
DUST_FORCE_EXIT_SOL=0.15
