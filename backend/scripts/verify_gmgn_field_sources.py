...
FIELD_ALIASES: Dict[str, List[str]] = {
    ...
    "suspected_insider_hold_rate": ["suspected_insider_hold_rate", "insider_hold_rate", "suspected_insider_rate", "suspected-insider-rate", "insider-hold-rate", "suspected-insider-hold-rate"],
