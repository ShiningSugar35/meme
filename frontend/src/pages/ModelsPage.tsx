...
const shortAlgo: Record<string, string> = { logistic_regression: "LR", decision_tree: "DT", hist_gradient_boosting: "HGB", gradient_boosting: "GB", ada_boost: "AdaBoost", extra_trees: "ExtraTrees", random_forest: "RF", rbf_svm: "RBF-SVM", xgboost: "XGBoost", lightgbm: "LightGBM", catboost: "CatBoost", flaml_automl: "FLAML" };
const modelLabel = (model: ModelVersion) => {
  ...
  return `${pick("year")}${pick("month")}${pick("day")}-${shortAlgo[model.algorithm] ?? model.algorithm}`;
};
