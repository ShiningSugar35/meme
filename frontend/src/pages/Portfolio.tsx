          ...
          <div className="card">
            ...
            {dsh.feature_stage_health && dsh.feature_stage_health.length > 0 && (
              <>
                ...
                <table style={{fontSize:12,marginTop:4}}><thead><tr><th>阶段</th><th>候选</th><th>通过</th><th>失败</th><th>API次数</th><th>Kline API</th><th>429</th><th>Kline异常</th></tr></thead><tbody>
